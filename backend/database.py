...
async def init_database():
    ...
    try:
        # Assets table (CREDIT/IRR, crypto, etc.)
        await db.execute("""
        ...
        # Accounts (user wallets per asset)
        await db.execute("""
        ...
        # Ledger entries (double-entry bookkeeping, immutable)
        await db.execute("""
        ...
        # Conversion quotes (rate locking)
        await db.execute("""
        ...
        # Rate alerts (user notifications)
        await db.execute("""
        ...
        # Transaction categories (smart categorization)
        await db.execute("""
